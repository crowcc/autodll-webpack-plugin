...
var validateCache = function validateCache(settings) {
  var cacheDir = (0, _paths.getCacheDir)(settings.cacheDir);
  var prevPkgPath = _path2.default.join(cacheDir, 'package.json.hash');

  return Promise.all([
    _fs2.default.lstatAsync(_path2.default.join(cacheDir, settings.hash)).catch(function() {
      return null;
    }),
    ...
    return (0, _makeDir2.default)(cacheDir)
      .then(function() {
