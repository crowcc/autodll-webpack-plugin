  ...
  _createClass(AutoDLLPlugin, [
    {
      ...
      value: function apply(compiler) {
        ...
        var memory = (0, _createMemory2.default)(settings.cacheDir);
        ...
        var attachDllReferencePlugin = (0, _once2.default)(function(compiler) {
          Object.keys(dllConfig.entry)
            .map((0, _paths.getManifestPath)(settings.hash, settings.cacheDir))
        ...
        var beforeCompile = function beforeCompile(params, callback) {
          ...
          [].concat(_toConsumableArray(dependencies)).filter(function(path) {
            return !path.startsWith((0, _paths.getCacheDir)(settings.cacheDir));
          });
          callback();
        };
        ...
        if (inject) {
          var getDllEntriesPaths = function getDllEntriesPaths(extension) {
            return (0, _flatMap2.default)(memory.getStats().entrypoints, 'assets')
          ...
          var doCompilation = function doCompilation(htmlPluginData, callback) {
            htmlPluginData.assets.js = [].concat(
              _toConsumableArray(getDllEntriesPaths('.js')),
              _toConsumableArray(htmlPluginData.assets.js)
            );
            htmlPluginData.assets.css = [].concat(
              _toConsumableArray(getDllEntriesPaths('.css')),
              _toConsumableArray(htmlPluginData.assets.css)
            );
