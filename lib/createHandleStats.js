...
var _createHandleStats = function _createHandleStats(fs) {
  return function(cacheDir, log, hash, memory) {
    var statsPath = (0, _path.join)((0, _paths.getCacheDir)(cacheDir), hash, 'stats.json');
...
exports.default = _createHandleStats(_fs2.default);
