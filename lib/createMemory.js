    ...
    return _bluebird2.default
      ...
      .map(function(filename) {
        return _bluebird2.default.props({
          filename,
          buffer: fs.readFileAsync(
            _path2.default.join((0, _paths.getCacheDir)(cacheDir), hash, filename)
          ),
        });
      })
      .each(function(_ref2) {
...
var _createMemory = (exports._createMemory = function _createMemory(fs) {
  return function(cacheDir) {
    var mfs = initializeMFS();

    return {
      sync: createSync((0, _paths.getCacheDir)(cacheDir), fs, mfs),
...
exports.default = _createMemory(_fs2.default);
